...
export default function LoadingPage() {
  ...
  const messages = [
    ...
    "👁️ Scanning left eye...",
    "👁️ Scanning right eye...",
    "👃 Analyzing nose structure...",
    "👄 Detecting lip shape and symmetry...",
    "👂 Evaluating ear alignment...",
    "👤 Measuring face shape and contour...",
    "🧠 Interpreting expression and emotion...",
    "🔎 Detecting emotions...",
